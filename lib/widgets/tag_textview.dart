...
abstract class TagText {}

/// Represents an element containing a link
class LinkElement extends TagText {
  final String url;
...
class HashTagElement extends TagText {
  final String tag;
...
class TextElement extends TagText {
  final String text;
...
/// Turns [text] into a list of [TagText]
